...
| HTTP 200 carrying an error envelope | provider | `{"error": …}` envelope (object, bare-string, or string-array form) | fail over to the next model; an envelope 429 pauses like a real 429 |
